...
public class MainPageObject {
    ...
    public WebElement waitForElementAndCheckText(By by, String error_message, long timeoutInSeconds)
    {
        WebElement element = waitForElementAndClick(by, error_message, timeoutInSeconds);
    ...
    public void assertElementNotPresent(By by, String error_massage)
    {
